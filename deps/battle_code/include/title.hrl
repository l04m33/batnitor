...
-define(LEGEND_TYPE_KILL_BOSS,			3).
...
-define(SUPREMACY_INDEX_RECV_FLOWER_LEN,	10).	%% 收花至尊称号数量
...
-define(LEGEND_INDEX_KILL_BOSS,			11).	%% 狩猎之王
...
%% ========================= 特殊称号 ============================= %%
-define(SPECIAL_INDEX_OLD_PLAYER, 1).
